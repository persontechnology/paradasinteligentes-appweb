    ...
    <div class="card" id="mapContainer">
        <div class="card-header">
            ...
            <div class="input-group">
                ...
                <select  class="form-select select"  data-enable-filtering="true" data-enable-case-insensitive-filtering="true" id="buscarparadas" onchange="buscarParada(this);">
...
console.log(paradas)
        ...
        }).setView([-1.043969088281657, -78.59113567947298], 16);
